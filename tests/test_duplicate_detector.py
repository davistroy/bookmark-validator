...
class TestDuplicateDetector:
    ...
    def test_normalize_url_basic(self, duplicate_detector):
        ...
        assert duplicate_detector.normalize_url("http://example.com") == "https://example.com"
        assert duplicate_detector.normalize_url("https://example.com") == "https://example.com"
        
        # Test WWW normalization
        assert duplicate_detector.normalize_url("https://www.example.com") == "https://example.com"
        
        # Test trailing slash normalization
        assert duplicate_detector.normalize_url("https://example.com/page/") == "https://example.com/page"
        assert duplicate_detector.normalize_url("https://example.com/") == "https://example.com/"  # Root path preserved
    ...
    def test_normalize_url_edge_cases(self, duplicate_detector):
        ...
        assert duplicate_detector.normalize_url("https://example.com/page#section") == "https://example.com/page"
    ...
    def test_resolve_duplicates_newest(self, duplicate_detector, sample_bookmarks):
        ...
        duplicate_groups = duplicate_detector.detect_duplicates(sample_bookmarks)
        resolved_groups = duplicate_detector.resolve_duplicates(duplicate_groups, "newest")
    ...
    def test_resolve_duplicates_oldest(self, duplicate_detector, sample_bookmarks):
        ...
        duplicate_groups = duplicate_detector.detect_duplicates(sample_bookmarks)
        resolved_groups = duplicate_detector.resolve_duplicates(duplicate_groups, "oldest")
    ...
    def test_resolve_duplicates_most_complete(self, duplicate_detector, sample_bookmarks):
        """Test duplicate resolution with 'most_complete' strategy"""
        duplicate_groups = duplicate_detector.detect_duplicates(sample_bookmarks)
        resolved_groups = duplicate_detector.resolve_duplicates(duplicate_groups, "most_complete")
    ...
    def test_resolve_duplicates_highest_quality(self, duplicate_detector, sample_bookmarks):
        """Test duplicate resolution with 'highest_quality' strategy"""
        duplicate_groups = duplicate_detector.detect_duplicates(sample_bookmarks)
        resolved_groups = duplicate_detector.resolve_duplicates(duplicate_groups, "highest_quality")
