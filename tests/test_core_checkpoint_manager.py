...
class TestProcessingState:
    ...
    def test_from_dict(self):
        ...
        assert len(restored_data.processed_bookmarks) == len(original_data.processed_bookmarks)
...
class TestCheckpointIntegration:
    ...
    def test_checkpoint_size_optimization(self, temp_dir):
        ...
        compressed_id = manager_compressed.save_checkpoint("large_test", checkpoint_data)
        uncompressed_id = manager_uncompressed.save_checkpoint("large_test", checkpoint_data)
        ...
        assert len(compressed_loaded.processed_bookmarks) == len(uncompressed_loaded.processed_bookmarks)
