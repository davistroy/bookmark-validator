...
from bookmark_processor.core.data_models import Bookmark, BookmarkMetadata, ProcessingStatus
...
MOCK_AI_RESULTS = {
    "https://docs.python.org/3/": {
        ...
        "generated_tags": ["python3", "documentation", "programming", "reference", "tutorial"],
...
def create_sample_processed_bookmark() -> Bookmark:
    ...
    # Add processed data
    bookmark.enhanced_description = MOCK_AI_RESULTS["https://docs.python.org/3/"]["enhanced_description"]
    bookmark.optimized_tags = MOCK_AI_RESULTS["https://docs.python.org/3/"]["generated_tags"]
