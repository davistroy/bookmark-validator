...
class MockRequestsSession:
    ...
    def add_error_response(self, url: str, error_class=requests.ConnectionError, error_message="Mock error"):
...
class MockAIProcessor:
    ...
    def __init__(self, success_rate: float = 1.0, processing_delay: float = 0.0):
        ...
        self.predefined_results = {
            "https://docs.python.org/3/": {
                ...
                "generated_tags": ["python3", "documentation", "programming", "reference"]
            },
            "https://github.com/microsoft/vscode": {
                "enhanced_description": "Open-source code editor by Microsoft with extensible features",
                "generated_tags": ["vscode", "editor", "microsoft", "opensource", "development"]
            },
    ...
    def process_bookmark(self, bookmark: Bookmark) -> Bookmark:
        ...
        if bookmark.url in self.predefined_results:
            ...
            bookmark.enhanced_description = f"AI-enhanced description for {bookmark.get_effective_title()}"
...
class MockContentAnalyzer:
    ...
    def extract_metadata(self, url: str, content: Optional[str] = None) -> Optional[BookmarkMetadata]:
...
class MockProgressTracker:
    ...
    def update(self, completed: int, message: Optional[str] = None):
        ...
        self.current_progress = completed / self.total_items if self.total_items > 0 else 0.0
