...
class TestCustomExceptions:
    ...
    def test_network_error(self):
        ...
        error = NetworkError("Network failed", url="https://example.com", status_code=404)
    ...
    def test_ai_processing_error(self):
        ...
        error = AIProcessingError("AI failed", model="test-model", input_text="test input")
...
class TestRetryHandler:
    ...
    def test_should_retry_success(self):
        ...
        assert handler.should_retry(ValueError("test"), attempt=1) is False  # Non-retryable error
    ...
    def test_should_retry_retryable_error(self):
        ...
        assert handler.should_retry(retryable_error, attempt=3) is False  # Max attempts reached
