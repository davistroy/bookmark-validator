...
class TestBookmark:
    ...
    def test_from_raindrop_export(self):
        ...
        assert bookmark.excerpt == "Welcome to Python.org, the official documentation for Python programming language."
    ...
    def test_get_all_tags(self):
        ...
        bookmark.optimized_tags = ["optimized1", "optimized2", "original1"]  # Some overlap
        bookmark.extracted_metadata = BookmarkMetadata(keywords=["keyword1", "original1"])
...
class TestProcessingResults:
    ...
    def test_url_validation_rate(self):
        ...
        results = ProcessingResults(
            url_validation_success=80,
            url_validation_failed=20
        )
    ...
    def test_ai_processing_rate(self):
        ...
        results = ProcessingResults(
            ai_processing_success=70,
            ai_processing_failed=30
        )
