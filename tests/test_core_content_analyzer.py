...
class TestCorpusAwareTagGenerator:
    ...
    def test_suggest_similar_tags(self):
        ...
        has_related = any(term in tag.lower() for tag in similar_tags for term in related_terms)
    ...
    def test_finalize_tag_optimization(self):
        ...
        assert len(all_tags) <= generator.target_tag_count * 1.2  # Allow some flexibility
