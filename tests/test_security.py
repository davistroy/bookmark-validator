...
class TestSecurityValidator:
    ...
    def test_allowed_schemes(self):
        ...
        for url in safe_urls:
            ...
            assert 'javascript' not in result.blocked_reason if result.blocked_reason else True
...
class TestSecureLogger:
    ...
    def test_url_sanitization(self):
        ...
        for url in urls:
            ...
            assert '***PASSWORD_REDACTED***' in sanitized or '***REDACTED***' in sanitized or '***USER***' in sanitized
...
class TestPenetrationTests:
    ...
    def test_injection_prevention(self):
        ...
        for payload in injection_payloads:
            result = self.validator.validate_url(payload)
            assert not result.is_valid, f"Injection payload should be blocked: {payload}"
            assert result.error_type == "security_error"
