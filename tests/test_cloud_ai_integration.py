...
from bookmark_processor.core.ai_factory import AIManager, AIFactory
...
class TestCloudAIIntegration:
    ...
    async def test_ai_manager_fallback(self, mock_config):
        ...
        with patch.object(ai_manager, '_initialize_clients'):
            ...
            ai_manager.fallback_client.generate_description = AsyncMock(
                return_value=("Fallback description", {"provider": "local", "success": True})
            )
    ...
    async def test_batch_processing_with_claude(self, mock_request, mock_config, sample_bookmarks):
        """Test batch processing with Claude API."""
        # Mock Claude API response
        mock_request.return_value = {
            "content": [{"text": "Test description 1\nTest description 2\nTest description 3"}],
    ...
    async def test_batch_processing_with_openai(self, mock_request, mock_config, sample_bookmarks):
        """Test batch processing with OpenAI API."""
        # Mock OpenAI API response
        mock_request.return_value = {
            "choices": [{
                "message": {"content": "1. Test description 1\n2. Test description 2\n3. Test description 3"}
            }],
    ...
    async def test_cost_confirmation_workflow(self):
        ...
        cost_tracker = CostTracker(confirmation_interval=1.0)  # Low threshold for testing
    ...
    async def test_end_to_end_cloud_ai_workflow(self, mock_config, sample_bookmarks):
        ...
        with patch('bookmark_processor.core.claude_api_client.ClaudeAPIClient._make_request') as mock_claude:
    ...
    def test_prompt_optimization(self):
        ...
        claude_prompt = claude_client._create_bookmark_prompt(bookmark, "existing content")
        ...
        openai_messages = openai_client._create_bookmark_prompt(bookmark, "existing content")
