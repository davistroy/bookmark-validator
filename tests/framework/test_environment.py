...
class IntegrationTestEnvironment:
    ...
    def setup(self) -> None:
        ...
        self.logger.info(
            f"Setting up integration test environment: {self.config.test_id}"
        )
    ...
    def cleanup(self) -> None:
        ...
        self.logger.info(
            f"Cleaning up integration test environment: {self.config.test_id}"
        )
    ...
    def _generate_test_config_content(self) -> str:
        ...
        network_settings = NetworkSimulator.get_network_settings(
            self.config.network_simulation
        )
...
"""
    ...
    def _setup_mock_services(self) -> None:
        ...
        self.services["network_simulator"] = NetworkSimulator(
            self.config.network_simulation
        )
    ...
    def create_test_file(
        self, name: str, content: str, directory: str = "temp"
    ) -> Path:
...
class NetworkSimulator:
    ...
    def __init__(self, profile: str = "fast"):
        ...
        self.settings = self.NETWORK_PROFILES.get(
            profile, self.NETWORK_PROFILES["fast"]
        )
