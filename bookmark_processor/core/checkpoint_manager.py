...
class ProcessingState:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "ProcessingState":
        ...
        data["last_checkpoint_time"] = datetime.fromisoformat(
...
class CheckpointManager:
    ...
    def load_checkpoint(
        ...
        try:
            ...
            if input_file and state.input_file != input_file:
                logging.warning(
                    f"Checkpoint input file mismatch: "
            ...
            logging.info(
                f"Loaded checkpoint from stage {state.current_stage.value} "
    ...
    def add_validated_bookmark(
        self, validation_result: ValidationResult, bookmark: Bookmark
    ) -> None:
        ...
        with self.lock:
            if validation_result.is_valid:
                ...
                self.current_state.failed_validations.append(
        ...
        with self.lock:
            ...
            if self.current_state.total_bookmarks > 0:
                progress_info["progress_percentage"] = (
                    ...
                    / self.current_state.total_bookmarks
                    * 100
                )
            else:
    ...
    def cleanup_old_checkpoints(self, keep_count: int = 3) -> None:
        ...
        try:
            ...
            logging.info(
                f"Cleaned up {len(checkpoint_files) - keep_count} old checkpoints"
            )
