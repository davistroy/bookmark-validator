...
class ContentAnalyzer:
    ...
    def __init__(
        ...
        if max_content_size is not None:
            ...
            self.max_content_size = (
                1024 * 1024
            )  # 1MB default for backward compatibility
        ...
        try:
            if user_agent:
                ...
                self.user_agent = self.browser_simulator.get_headers("").get(
                    "User-Agent"
                )
    ...
    def extract_metadata(self, url: str) -> Optional[BookmarkMetadata]:
        ...
        try:
            ...
            metadata = BookmarkMetadata(
                ...
                keywords=(
                    content_data.meta_keywords.split(", ")
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        success_rate = (
            (self._stats["successful_extractions"] / total * 100) if total > 0 else 0.0
        )
