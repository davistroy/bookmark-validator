...
class BrowserSimulator:
    ...
    def __init__(self, rotate_agents: bool = True, session_persistence: bool = True):
        ...
        logging.info(f"Initialized browser simulator with {len(self.USER_AGENTS)} user agents")
        ...
        try:
            ...
            if user_agents_file.exists():
                ...
                if additional_agents:
                    ...
                    logging.info(f"Loaded {len(additional_agents)} additional user agents from file")
