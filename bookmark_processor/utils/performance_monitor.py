...
class PerformanceMonitor:
    ...
    def _collect_metrics(self):
        ...
        with self.lock:
            ...
            try:
                ...
                memory_mb = memory_usage.ru_maxrss / 1024  # On Linux, ru_maxrss is in KB
                if hasattr(resource, 'getrusage') and os.name != 'posix':
                    memory_mb = memory_usage.ru_maxrss / 1024 / 1024  # On Windows, it's in bytes
            ...
            rate_per_hour = self.items_processed / elapsed_hours if elapsed_hours > 0 else 0
    ...
    def get_current_performance(self) -> Dict[str, Any]:
        ...
        with self.lock:
            ...
            rate_per_hour = self.items_processed / elapsed_hours if elapsed_hours > 0 else 0
            estimated_completion = (self.target_items - self.items_processed) / rate_per_hour if rate_per_hour > 0 else float('inf')
            
            progress_percent = (self.items_processed / self.target_items * 100) if self.target_items > 0 else 0
            ...
            return {
                ...
                'network_success_rate': (self.network_requests - self.network_failures) / self.network_requests * 100 if self.network_requests > 0 else 0,
    ...
    def get_performance_analysis(self) -> Dict[str, Any]:
        ...
        for stage_name, summary in stage_summary.items():
            if summary['executions'] > 0:
                ...
                summary['avg_items_per_execution'] = summary['total_items'] / summary['executions']
                summary['items_per_second'] = summary['total_items'] / summary['total_duration'] if summary['total_duration'] > 0 else 0
    ...
    def _identify_bottlenecks(self) -> List[str]:
        ...
        for stage_name, summary in self.get_performance_analysis()['stage_analysis'].items():
